<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintTicket.aspx.cs" Inherits="Bus_Management_Client.PrintTicket" %>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="TextBox1" AutoCompleteType="Email" runat="server"></asp:TextBox>
          <p>
            <asp:Button ID="Button1" runat="server" Height="47px" OnClick="Button1_Click" Text="Submit" Width="121px" />
        </p>
